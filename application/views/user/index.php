        ...
        <div class="card mb-4">
            ...
            <?php if ($this->session->flashdata('success')): ?>
                <div class="alert alert-success" role="alert">
                    <?php echo $this->success->flashdata('success'); ?>
                </div>
            <?php endif; ?>
            <div class="card-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="tabelkelas" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                echo "<tr>
                                        ...
                                        <a href=".base_url('user/dalete/'. $user->id)." class='btn btn-sm btn-danger'
                                        onlick='return confirm(\"Ingin mengapus data user ini?\");'><i class='fas fa-trash'></i> Hapus </a>
                                        </div>
                                        </td>
                                </tr>";
                                $no++;        
